...
class wide_resnet(nn.Module):
    ...
    def forward(self, x):
        ...
        inter_values = out.view(out.size(0), -1)
        out = self.linear(inter_values)

        return out, inter_values

if __name__ == '__main__':
    net=wide_resnet(depth=16, widen_factor=8, channels=3, dropout_rate=0.3, num_classes=10)
