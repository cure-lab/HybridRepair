...
#     checkpoint = torch.load('cifar10/resnet50/checkpoint_0900.pth.tar')
...
#         normalize,
#         ])
# dataset1 = torchvision.datasets.CIFAR10('/research/d4/gds/mxchen21/mixian/datasets/cifar10', transform=val_transform, train=True, download=True)
# dataset2 = torchvision.datasets.CIFAR10('/research/d4/gds/mxchen21/mixian/datasets/cifar10', transform=val_transform, train=False, download=True)
# dataset = torch.utils.data.ConcatDataset([dataset1, dataset2])
# fe,y = get_feature(dataset)
# print(fe.shape)